...
Then it plots the exact values and approximations on the [-1:0.001:2] domain to showcase how the approxiamtions approach the root.
...
Then it plots on figure 1 the exact values and approximation midpoints on the [-3:0.001:3] domain to showcase how the approxiamtions approach the root.
...
This contains the coded version of f(x) = -x^3 + x^2 + x + 1 for Computer Problem 1 and its hand-derived derivative (see report), returnin both f(x) and f'(x).

### function_02.m 

This contains the coded version of f(x) = 2x * (1 + x^2)^(-1) - arctan(x) for Computer Problem 2 and its hand-derived derivative (see report), returnin both f(x) and f'(x).

### function_03.m 

This contains the coded version of f(x) = x^3 - 2x((4 - tan(x)) / (sin(x) + 3x^2)) + ((4 - tan(x)) / (sin(x) + 3x^2))^7 + 4x^3((4 - tan(x)) / (sin(x) + 3x^2)) - 5 for Computer Problem 3 and its hand-derived derivative (see report), returnin both f(x) and f'(x).
